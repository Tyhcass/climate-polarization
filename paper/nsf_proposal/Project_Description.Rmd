...
Our preliminary data collection from 93 different survey datasets from 1992 to 2022 highlights this sparsity, with only 3,830 country-year-item available observations representing 37% of the total possible data.
...
This approach tests  how current levels of public concern about climate change contribute to the existing level of climate laws and regulations.\footnote{ 
...
To this date, we have gathered survey data from 85 countries, each with an average of 19 years of estimates.\footnote{This is supported by a seed grant from the Center of Social Data Analytics (C-SODA) of the Penn State University, 2022-2023.}
