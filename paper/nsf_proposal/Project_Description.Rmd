...
Among these, the Dynamic Comparative Public Opinion model (DCPO) [@solt2020modeling] has been widely used to measure comparative public opinion and has successfully created comparative data for gender egalitarianism [@woo2023public], macrointerest [@humacrointerest], and tolerance of homosexuality [@woo2023measuring].
...
Figure\nobreakspace{}\ref{pocc-plot} shows how the available data have influenced scholarship on the topic.
...
Compared to other models, such as @mcgann2019parallel and @kolczynska2024modeling, which require dense survey data or ancillary data on population characteristics, DCPO is specifically designed to address issues of incomparability and sparsity in comparative opinion data over time with fewer data requirements.
...
We propose a two-year project. 

Fall 2025: Raw data collection.

Spring 2026: Document climate change public opinion estimates.

Summer 2026: Revise DCPO models and packages for estimating polarization.

Fall 2026:  Estimate climate change polarization.

Spring 2027: Document climate change polarization estimates.
