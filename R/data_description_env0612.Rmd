...
surveys <-  read_csv(here::here("rawdata/climate_index_env.csv"),
                    col_types = "ccccccc") 

dcpo_input_raw_cc <- read_csv(here::here("rawdata/dcpo_input_raw_env.csv")) %>%
  select(-1)
...
```{r inputdata}
dcpo_input_raw_env <- read_csv(here::here("rawdata/dcpo_input_raw_env.csv")) %>%
  select(-1) %>%
